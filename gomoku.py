...
if __name__ == '__main__':
  ...
  parser.add_argument('-a', "--algorithm", type=str, default="minmax", choices=["random", "minmax"], help="algorithm for the bot")
  ...
  if args.mode == 'pvp':
    ...
    play_agent(args.algorithm)
  elif args.mode == 'botvsbot':
    botvsbot(args.algorithm)